...
module.exports = {
    ...
    getDetail: async (req, res, next) => {
        try {
            ...
            if (!results) {
                return res.send(404, { message: `Không tìm thấy nhà cung cấp nào có ID là: ${id}` });
            }
    ...
    update: async (req, res, next) => {
        try {
            ...
            if (errors.length > 0) {
                return res.send(400, { message: `Cập nhật nhà cung cấp thất bại,${errors}` })
            }
            ...
            if (!updateSupplier) {
                return res.send(404, { message: `Không tìm thấy nhà cung cấp có ID: ${id}` })
            }
    ...
    restore: async (req, res, next) => {
        try {
            ...
            if (!result) {
                return res.send(400, { message: `nhà cung cấp có ID: ${id} không tìm thấy hoặc đã khôi phục rồi` });
            }
